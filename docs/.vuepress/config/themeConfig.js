...
module.exports = {
  ...
  logo: '/img/L.png', // 导航栏logo
  repo: 'lukexiaoyu/blog_xiao', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'lukexiao', // 必需
    link: 'https://github.com/lukexiaoyu', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:814008000@163.com',
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/lukexiaoyu',
      },
      {
        iconClass: 'icon-erji',
        title: '听音乐',
        link: 'https://music.163.com/#/user/home?id=87227351',
      },
    ],
  },
  footer: {
